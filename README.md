...
При запуске программы логи записываются в директорию logs
...
**3. Модуль utils - Получение информации о сумме транзации в RUB из файла JSON**
**4. Модуль data_readers - Поддеррживает чтение файлов CSV и XLSX**